...
-- Questa migration è la fonte di verità per lo stack locale (`supabase start` +
-- `supabase db reset`) ed è identica a db/schema.sql (lasciato come riferimento
-- per chi preferisce incollarlo a mano nello SQL Editor della console cloud).
...
-- ============================ Storage (fatture PDF) ============================
-- Bucket privato delle fatture, con accesso per-utente (ogni file va salvato
-- sotto una cartella col proprio user id: "<uid>/<file>.pdf").
